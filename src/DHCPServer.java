...
public class DHCPServer 
{
	...
	public DHCPServer() {
		...
		try {
				...
				input = new FileReader("C:/Users/Anand/Desktop/DHCP Server Storage.txt");
	...
	public static void updateAssignedIp() {
		...
		{				
				...
				
			{
				...
				BufferedWriter outputStream = new BufferedWriter(new FileWriter("C:/Users/Anand/Desktop/DHCP Server Storage.txt",false));
				for (int i=0; i < ipTable.length ; i++) 
				{
