...
{
	public static String  HASHMAPFILE= "C:/Users/Anand/Desktop/Allocated IP Pool.txt";
	public static String CONFIGFILE = "C:/Users/Anand/Desktop/IPPool.txt";
	...
	public void dowork() throws Exception
	{
		try 
		{
			...
			while (true) 
			{
				...
				System.out.println("*****************************************************");
				System.out.println("Client " + count +  " : connected to Server, " + thread.toString());
				System.out.println("*****************************************************\n");
				thread.start();
			}
		} 
	...
	public void run()
	{
		try 
		{
			...
			while ((readline = in.readLine()) != null) 
			{
				...
				{
					System.out.println("Server message IPREQ recieved" );
					
					String Ip = poolobj.getIP();
					
					System.out.println("offering IP : " + Ip );
					out.println(Ip);
					out.flush();
					if((readline = in.readLine()) != null)
					{
						if(readline.equals("ACK"))
							System.out.println("Server ack recieved");
						else if(readline.equals("NACK"))
						{

							System.out.println("Server negative ack recieved,release IP back to the Pool");
				...
				{
					System.out.println("Server message IPREL recieved" );
					out.println("OK");
					out.flush();
					if((readline = in.readLine()) != null)// client sends the IP
					{
						// Function to Update IP pool
						System.out.println("Server released IP : " + readline);
